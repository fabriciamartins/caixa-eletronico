...
public class SandanderProcessadorDigitandoConta extends MaquinaAdapter implements ProcessadorEstado{

	private List<EstadoListener> listeners;
	private int contaDigitada;
	
	public SandanderProcessadorDigitandoConta(){
	...
	public void teclaNum01Digitada() {
		...
		MaquinaSantander.instance.configurarEvento(msg, DIGITANDO_CONTA, null);
	}
	...
	public void teclaConfirmaDigitada() {
		for (EstadoListener listener : this.listeners) {
			listener.estadoAcabou(new SantanderProcessadorDigitandoSenha());
		}
		MaquinaSantander.instance.setContaDigitada(contaDigitada);
